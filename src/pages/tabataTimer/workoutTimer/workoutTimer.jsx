...
// export const WorkoutTimer = () => {
//   const {
//     timer: { time, rounds, currentRound, phase, isRunning },
//     handleStart,
//     handleStop,
//     handleReset
//   } = useWorkoutTimer();
...
//       <div className={styles.timerContent}>
//         <h1>ТАБАТА ТАЙМЕР</h1>
//         <h2 className={styles.title}>{phaseTitles[phase]}</h2>
//         <h3>Время:</h3>
//         <div className={styles.timerValue}>{formatTime(time)}</div>
//         <div className={styles.roundInfo}>
//           <h3>Раунд:</h3>
...
export const WorkoutTimer = () => {
  const { time, rounds, currentRound, phase, isRunning, isWorkoutCompleted, formatTime, handleStart, handleStop, handleReset } = useWorkoutTimer();
